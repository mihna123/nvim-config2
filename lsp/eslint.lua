-- Functions taken from github.com/neovim/nvim-lspconfig/blob/master/lua/lspconfig/util.lua
-- Done so that we dont have to add lspconfig just for two functoins
